...
const ELEMENTS_81_118 = [
  ...
  { n: 84, s: "Po", en: "Polonium", hi: "पोलोनियम", m: 209, c: "post-transition", p: 6, g: 16, b: "p", ec: "[Xe]4f¹⁴5d¹⁰6s²6p⁴", en_v: 2.0, mp: 254, bp: 962, d: 9.32, st: "solid", db: { en: "Marie Curie", hi: "मैरी क्यूरी" }, y: 1898, f: { en: "Named after Poland by Marie Curie!", hi: "मैरी क्यूरी द्वारा पोलैंड के नाम पर!" } },
...
const UI_TRANSLATIONS = {
  en: {
    ...
    subtitle: "Explore all 118 elements with interactive Bohr model visualizations and quizzes!",
    ...
    stable: "Stable",
    radioactiveStatus: "Radioactive (Unstable)"
  },
  hi: {
    title: "इंटरैक्टिव आवर्त सारणी",
    subtitle: "बोहर मॉडल विज़ुअलाइज़ेशन और क्विज़ के साथ सभी 118 तत्वों का अन्वेषण करें!",
    search: "तत्व खोजें...",
    ...
    stable: "स्थिर",
    radioactiveStatus: "रेडियोधर्मी (अस्थिर)"
  }
};
